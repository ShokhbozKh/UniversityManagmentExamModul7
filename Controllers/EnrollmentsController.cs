...
namespace PDP_Examp.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.DateTimeEnroll = DateTime.Now;
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CreatedDate,CourseAssignmentId,StudentId")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreatedDate,CourseAssignmentId,StudentId")] Enrollment enrollment)
        {
            if (id != enrollment.Id)
            {
                return NotFound();
